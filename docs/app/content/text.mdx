...
| Factory | Config | Required |
| --- | --- | --- |
| `Tokenizer.fromTiktoken` | `TiktokenConfig` | `model` |
| `Tokenizer.fromBpe` | `BpeConfig` | `vocabPath`, `mergesPath` |
| `Tokenizer.fromWordPiece` | `WordPieceConfig` | `vocabPath` |
| `Tokenizer.fromSentencePiece` | `SentencePieceConfig` | `modelPath` |
