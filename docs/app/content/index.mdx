...
- **Records as models** -- models are plain F# records. Built-in layers mark trainable state explicitly, and `Model.trainableParams` discovers it without a base class.
...
Nested records compose naturally. `Model.trainableParams` walks the supported model structure and returns canonical named parameters.
